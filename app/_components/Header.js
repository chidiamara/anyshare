...
const Header = () => {
  ...
  <div className="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8">
    <a className="block text-gray-900" href="/">
      <Image src='/logo.svg' width={30} height={100}/>
      <span className="  text-gray-500 transition hover:text-gray-500/75">AnyShare</span>
    </a>
    ...
    <div className="flex flex-1 items-center justify-end md:justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="sm:flex sm:gap-4">
          <a
            className="block rounded-md bg-gray-900 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-gray-700"
            href="/"
          >
            Get Started
          </a>
